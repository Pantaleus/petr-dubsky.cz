...
if ($article_slug) {
    try {
        $sql = "SELECT 
                ...
                WHERE a.slug = :slug AND at.lang_code = :lang_code AND a.article_type = 'raspberry'
...
function lang_url_raspberry_article($lang_code_param, $article_slug_param, $base_url = 'article.php') {
...
<head>
    ...
    <title><?php echo $article_full_data ? htmlspecialchars($article_full_data['meta_title']) : htmlspecialchars($page_title_override ?? $lang['nav_raspberry'] ?? 'Raspberry'); ?> - <?php echo htmlspecialchars($lang['meta_title']); ?></title>
                ...
                <article class="article-full">
                    ...
                    <div class="article-navigation">
                        <a href="index.php?lang=<?php echo $current_lang_code; ?>" class="btn btn-secondary">
                            « <?php echo htmlspecialchars($lang['blog_back_to_list'] ?? 'Zpět na výpis'); // Přidejte do lang ?>
                        </a>
            ...
            <?php else: ?>
                <div class="article-not-found">
                    ...
                    <a href="index.php?lang=<?php echo $current_lang_code; ?>" class="btn btn-primary">
                        « <?php echo htmlspecialchars($lang['blog_back_to_list'] ?? 'Zpět na výpis'); ?>
                    </a>
                </div>
            <?php endif; ?>
        </div>
