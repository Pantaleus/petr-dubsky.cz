...
try {
    ...
    $sql = "SELECT 
            ...
            WHERE at.lang_code = :lang_code AND a.article_type = 'raspberry'
...
function lang_url_raspberry($lang_code_param, $base_url = 'index.php', $article_slug_param = null) {
...
<head>
    ...
    <title><?php echo htmlspecialchars($lang['nav_raspberry'] ?? 'Raspberry Pi'); ?> - <?php echo htmlspecialchars($lang['meta_title']); ?></title>
    <meta name="description" content="Insights and articles about Raspberry Pi by Pietro Dubsky.">
...
<body>
    ...
    <main class="blog-main section-padding">
        <div class="container">
            <h1 class="page-title"><?php echo htmlspecialchars($lang['nav_raspberry'] ?? 'Raspberry Pi'); ?></h1>
